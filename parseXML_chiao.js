...
function ImportGeojson(geojson) {
    ...
    function myStyleFunctionLev(feature) {
        ...
        /*console.log("longtitude:" + feature.get('longtitude'));*/
        if (feature.get('latitude') == '27.025') {
            console.log("latitude:" + feature.get('latitude'));
        }


        /*if (feature.get('rainfall') > 0 && feature.get('rainfall') <= 2500) {
            console.log(">0:" + feature.get('rainfall'));
            return myStyles.lev1;
        }
        else if (feature.get('rainfall') == '-1') {

            console.log("-1:" + feature.get('rainfall'));
            return myStyles.lev2;
        }
        else if (feature.get('rainfall') > 5000 && feature.get('rainfall') <= 7500) {

            return myStyles.lev3;
        }
        else if (feature.get('rainfall') > 7500 && feature.get('rainfall') <= 10000) {
